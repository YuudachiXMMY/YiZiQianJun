...
screen game_map_news(lst, month, title):
    ...
    if month[title]["times"]>0 and renpy.get_screen("game_map_main") and player_newsgrade!=5 and game_map_global_time<=5:
...
screen game_map_news_action(lst, month, title, page):
    ...
    if page<len(month[title]["detail"]) and month[title]["times"]>0 and renpy.get_screen("game_map_main") and player_newsgrade!=5 and game_map_global_time<=5:
        ...
        fixed:
            ...
            window:
                ...
                imagebutton:
                    ...
                    if renpy.get_screen("game_map_news_action_decision_publish"):
                        action Function(publishNewsINMonth, month=str(month), key=title, opt="opt1_result"), Show("game_map_main", lst=lst, month=month, transition=Dissolve(0.5))
                    elif renpy.get_screen("game_map_news_action_decision_delete"):
                        action Function(deleteNewsINMonth, month=str(month), key=title, opt="opt1_result"), Show("game_map_main", lst=lst, month=month, transition=Dissolve(0.5))
                    else:
                        action NullAction()
            ...
            window:
                ...
                imagebutton:
                    ...
                    auto "map_gui_publishnews_%s"
                    if renpy.get_screen("game_map_news_action_decision_publish"):
                        action Function(publishNewsINMonth, month=str(month), key=title, opt="opt2_result"), Show("game_map_main", lst=lst, month=month, transition=Dissolve(0.5))
                    elif renpy.get_screen("game_map_news_action_decision_delete"):
                        action Function(deleteNewsINMonth, month=str(month), key=title, opt="opt2_result"), Show("game_map_main", lst=lst, month=month, transition=Dissolve(0.5))
                    else:
                        action NullAction()
...
screen game_map_news_action_decision_publish(lst, month, title):
    ...
    if month[title]["times"]>0 and renpy.get_screen("game_map_news_action_decision") and player_newsgrade!=5:
...
screen game_map_building_detail(lst, month, type):
    ...
    if renpy.get_screen("game_map_main") and player_newsgrade!=5 and game_map_global_time<=5:
