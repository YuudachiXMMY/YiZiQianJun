...
screen shop():
    ...
    if renpy.get_screen(["shop_news_month_1", "shop_news_month_2", "shop_mag",
                        "shop_letter", "shop_shop_page_news1", "shop_shop_page_news2",
                        "shop_shop_page_news3", "shop_shop_page_paper"]):
